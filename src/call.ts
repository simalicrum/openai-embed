...
const program = new Command()
  .option(
    "-i, --input-file <file>",
    "Input values to send to the vectorstore agent in JSONL format."
  )
  .requiredOption(
    "-v, --vector-store <dir>",
  ...
  .requiredOption(
    "-d, --vector-store-description <description>",
    "Description of the vectorstore."
  )
  .option(
    "-o, --output-file <file>",
    "Chain values to output in JSONL format."
  );
